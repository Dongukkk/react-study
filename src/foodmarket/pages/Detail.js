    ...
    */
    ...
    /*
        ...
        <p className={ food.price >= 10000 ? 'price-red text-strong' : 'price-blue text-strong' }>{food.price}</p>
            ...
            백틱문자 활용 `
            <p className={ `text-strong ${food.price >= 10000 ? 'price-red text-strong' : 'price-blue text-strong' }`}>{food.price}</p>
    */
        ...
        <Container className={'start ' + viewClass}>
            <Row>
                ...
                <Col md={6}>
                    ...
                    <Button variant={food.stockCount==0 ? "danger" : "primary" }>
                        {food.stockCount==0 ? "품절": "주문하기"}
                    </Button>
